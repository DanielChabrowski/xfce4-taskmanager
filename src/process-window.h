...
void		xtm_process_window_set_system_info		(XtmProcessWindow *window, guint num_processes, gfloat cpu, gfloat memory, gchar* memory_str, gchar* swap_str);
void		xtm_process_window_show_cores_usage		(XtmProcessWindow *window, const GArray *cpu_info);
